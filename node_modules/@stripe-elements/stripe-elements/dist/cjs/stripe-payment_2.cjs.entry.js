...
const StripePayment = class {
  constructor(hostRef) {
    ...
    this.defaultFormSubmitResult = index.createEvent(this, "defaultFormSubmitResult", 7);
    /**
  ...
  render() {
    ...
    if (this.loadStripeStatus === 'failure') {
      return index.h("p", null, i18n.t('Failed to load Stripe'));
    }
    const disabled = this.progress === 'loading';
    return (index.h("div", { class: "stripe-payment-sheet-wrap" }, index.h("form", { id: "stripe-card-element" }, index.h("div", { class: "stripe-heading" }, i18n.t(this.sheetTitle)), index.h("div", { id: "stripe-payment-request-button" }), index.h("div", null, index.h("div", { class: "stripe-section-title" }, i18n.t('Card information'))), index.h("div", { class: "payment-info card visible" }, index.h("fieldset", { class: "stripe-input-box" }, index.h("div", null, index.h("label", null, this.showLabel ? index.h("lenged", null, i18n.t('Card Number')) : null, index.h("div", { id: "card-number" }))), index.h("div", { class: "stripe-input-column", style: { display: 'flex' } }, index.h("label", { style: { width: '50%' } }, this.showLabel ? index.h("lenged", null, i18n.t('MM / YY')) : null, index.h("div", { id: "card-expiry" })), index.h("label", { style: { width: '50%' } }, this.showLabel ? index.h("lenged", null, i18n.t('CVC')) : null, index.h("div", { id: "card-cvc" }))), index.h("div", { id: "card-errors", class: "element-errors" }, errorMessage))), this.zip ? (index.h("div", { style: { marginTop: '1.5rem' } }, index.h("div", { class: "stripe-section-title" }, i18n.t('Country or region')))) : null, this.zip ? (index.h("div", { class: "payment-info card visible" }, index.h("fieldset", { class: "stripe-input-box" }, index.h("div", null, index.h("label", null, this.showLabel ? index.h("lenged", null, i18n.t('Postal Code')) : null, index.h("input", { id: "zip", name: "zip", type: "text", inputmode: "numeric", class: "stripe-input-box StripeElement", style: { width: '100%' }, placeholder: i18n.t('Postal Code'), value: this.zipCode, onInput: e => {
        this.zipCode = e.target.value;
      } })))))) : null, index.h("div", { style: { marginTop: '32px' } }, index.h("button", { type: "submit", disabled: disabled }, this.progress === 'loading' ? i18n.t('Loading') : i18n.t(this.buttonLabel))))));
  }
...
const StripeSheet = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: `modal-row${open ? ' open' : ''}`, onClick: () => this.closeModal() }, index.h("div", { class: "modal-child", onClick: e => e.stopPropagation() }, showCloseButton ? (index.h("div", { class: "modal-close-button-wrap" }, index.h("ion-icon", { name: "close", size: "large", class: "modal-close-button", onClick: () => this.closeModal() }))) : null, index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
};
StripeSheet.style = stripeElementModalCss;

exports.stripe_payment = StripePayment;
exports.stripe_sheet = StripeSheet;
